...
| DW-36 | **Manager approval rights**                | Managers do not approve leave (D-08). The workflow engine supports it; the configuration does not enable it                                                                                                                                                                                                                                                                                                                                       | A company decision to change the routing. It is a settings change, not a code change                                                                                                                             |
